                ...
                <main class="content">
                    <div class="blackfriday-about">
                        ...
                        <form action="/" class="blackfriday-about__form" method="POST">
                            ...
                            <button type="submit" class="blackfriday-about__form-submit blackfriday__button">Хочу узнать первым!</button>
                            <div class="blackfriday-about__form-submit-ok">
                                 <p class="blackfriday-about__form-submit-ok-text">
                                    Вы успешно подписались!
                                    Теперь вы первыми узнаете о самых выгодных предложениях черной пятницы!
                                </p>
                                <a href="https://www.obi.ru" target="_blank" class="blackfriday-about__form-submit-ok-link blackfriday__button">Перейти на OBI.RU</a>
                            </div>
                        </form>
                    </div>
